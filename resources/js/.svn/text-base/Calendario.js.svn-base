...
/*  methods */
	...
	function Calendario_makeControlBar(){
		var stControlBar = 	"<TABLE cellspacing='0' width='50%' cellpadding='0' align='center' border='0' ><TR>" +
							"<TD width='50%' class='text'>" + this.obField.value + "</TD>" +
	...
	function Calendario_makeSelector(){
		...
		var stHeader = 	"<TABLE cellspacing='0' width='50%' cellpadding='0' align='center' border=0 ><TR>" +
		...
		stHeader +=		"</td></tr></TABLE>"+
						...
						"<table cellspacing='0' cellpadding='0' border='0'><tr><td width='13'>";
		if( topYear > inYear ){
			stHeader +=	"<IMG alt='Incrementar un A�o' style='cursor:hand;' border='0' hspace='0' vspace='0' align='bottom' src='" + this.stImagesDir + "up.gif' width='13' height='9'  onMouseDown='this.src=\"" + this.stImagesDir + "up_pressed.gif\"' onMouseOut='this.src=\""+ this.stImagesDir + "up.gif\"' onMouseUp='this.src=\"" + this.stImagesDir + "up.gif\";calendarioList["+this.calendarIndex+"].changeYear( 1 );'>";
		}else{
			stHeader +=	"<IMG border='0' hspace='0' vspace='0' align='bottom' src='" + this.stImagesDir + "disabled.gif' width='13' height='9'>";
		}
		...
		if( bottomYear < inYear ){
			stHeader +=	"<IMG alt='Decrementar un A�o' style='cursor:hand;' border='0' hspace='0' vspace='0' align='top' SRC='" + this.stImagesDir + "down.gif' width='13' height='9' onMouseDown='this.src=\"" + this.stImagesDir + "down_pressed.gif\"' onMouseOut='this.src=\""+ this.stImagesDir + "down.gif\"' onMouseUp='this.src=\"" + this.stImagesDir + "down.gif\";calendarioList["+this.calendarIndex+"].changeYear( -1 );'>";
		}else{
			stHeader +=	"<IMG border='0' hspace='0' vspace='0' align='bottom' src='" + this.stImagesDir + "disabled.gif' width='13' height='9'>";
		}
		stHeader +=		"</td></tr></TABLE>"+
	...
	function Calendario_makeFooter(){
		...
		var stFooter	= 	"<table width='50%' cellspacing='0' cellpadding='0' border='0'><tr>";
