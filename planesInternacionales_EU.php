...
include("contentleft.php");?>
      <div id="contentmid">
        ...
        <p>
          <font size=3>
          <b><u>Europa</u></b><br><br>
          </font>
          A continuacion se listan, en orden alfabetico, los documentos referentes a mitigacion vigentes en Europa:<br>
          <ul type="disc">
          <li>Espana:<br></li>
            <ul>
            <li><i>"Plan Andaluz de Accion por el Clima (2007-2012)".</i>
            <a href="docs/planClimaAndaluz.pdf"><img src="images/link.jpg" alt=""/></a><br></li>
            </ul>
        </ul>    
        </p>
        </div>
